...
public class ScaleTitleTextView extends AppCompatTextView {

    public ScaleTitleTextView(Context context) {
        super(context);
    }

    public ScaleTitleTextView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        setFontStyle(context);
    }

    public ScaleTitleTextView(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    private void setFontStyle(Context context) {
        ...
        if (diagonalInches >= 7.5) {
            setTextSize((AppFontSize + 0.8f) * 26.0f);
