package hk.gov.ogcio.wcag.widget.videoview;
...
public class UniversalMediaController extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        boolean isTalkBackEnabled = accessibilityManager.isEnabled() && accessibilityManager.isTouchExplorationEnabled();
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            ...
            mTurnButton.setContentDescription(mContext.getString(R.string.button_pause));
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.uvv_player_player_btn);
            mTurnButton.setContentDescription(mContext.getString(R.string.button_play));
//            mCenterPlayButton.setVisibility(VISIBLE);
        }
    }
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            ...
            mScaleButton.setContentDescription(mContext.getString(R.string.video_exit_full_screen));
        } else {
            mScaleButton.setImageResource(R.drawable.uvv_player_scale_btn);
            mScaleButton.setContentDescription(mContext.getString(R.string.video_full_screen));
        }
    }
